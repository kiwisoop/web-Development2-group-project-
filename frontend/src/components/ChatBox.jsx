...
import { getMatchChatMessages, sendMatchChatMessage } from '../api/chatApi';

export default function ChatBox({ matchId, isLoggedIn, disabledReason }) {
  ...
  const handleSend = async () => {
    ...
    setSendError(null);
    try {
      const res = await sendMatchChatMessage(matchId, trimmed);
